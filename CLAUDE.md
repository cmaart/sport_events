...
- **LadiesTri Breitenbrunn** (Breitenbrunn am Neusiedler See, Burgenland, AT) — abgesagt/eingestellt. Die Veranstalterseite UNION Triathlon Team Burgenland (uttb.at) führt den Menüpunkt „ABGESAGT – LadiesTri Neuer Strand"; die frühere Event-Domain ladies-triathlon.at löst nicht mehr auf (kein DNS für Apex und www). Im Terminkalender 2026 des Burgenländischen Triathlonverbands (burgenland-triathlon.at) ist das Event nicht mehr enthalten. Das spekulative Datum „23.08.2026" stammt nur von Aggregatoren (hdsports.org). Am 13.08.2026 entfernt. Nicht wieder anlegen, bis eine offizielle Veranstalterseite eine neue Ausgabe ankündigt.
